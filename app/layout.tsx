...
export const metadata: Metadata = {
  title: "Klar AI - Intelligence in motion.",
  description: "Your inbox on autopilot. Klar AI is the intelligent agent that manages your Gmail and Calendar via natural language and keyboard shortcuts.",
};
