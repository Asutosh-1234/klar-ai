...
export default async function GmailPage() {
  ...
  return (
    <div className="relative h-screen bg-background text-on-background flex flex-col font-sans overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 border-b border-white/[0.04] bg-surface-sidebar/80 backdrop-blur-xl">
      ...
      <main className="relative z-10 flex-1 flex flex-col max-w-7xl w-full mx-auto px-6 py-6 overflow-hidden h-[calc(100vh-4rem)]">
        {!isGmailConnected ? (
          <div className="flex-1 flex items-center justify-center py-20">
            <div className="glass-card rounded-xl p-8 max-w-md text-center border border-white/[0.06] flex flex-col items-center shadow-[0_12px_40px_rgba(0,0,0,0.5)] glow-accent">
